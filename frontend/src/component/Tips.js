import {InferenceClient} from "@huggingface/inference"
 export async function Tips(arr){
   ...
   try{
    const prompt = "Make sure the title of your response is internship tips with the name of the company in bold. Always introduce yourself like this:  'Hello i'm Toni Dada and i would love to assist you with your internship preparation'  before assisting and make sure you are using markdown format and also make sure you use the name of the company as the title in the request. Focus on providing links that would relate to the job requirement And make sure your texts are small. You've also been given 500 characters maximum, so make sure all the information you give is well within those characters. ONCE AGAIN!! MAKE SURE YOU HAVE 1000 words of content to give the user. ALso have some youtube videos as links "
